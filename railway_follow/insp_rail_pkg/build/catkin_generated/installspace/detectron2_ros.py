...
def main():
    ...
    if(args.weights=="default"):
        ...
        cfg.MODEL.WEIGHTS = os.path.join(ROOT,"/home/alaaeldin/follow_railway/src/railway_follow/insp_rail_pkg/model/Detectron2_Models/detectron2_50_sim4/model_final.pth",args.weights[0])
        cfg.merge_from_file(model_zoo.get_config_file("COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_3x.yaml"))
